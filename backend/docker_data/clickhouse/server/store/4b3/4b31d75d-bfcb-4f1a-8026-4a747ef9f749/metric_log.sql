ATTACH TABLE _ UUID '00ff8607-395f-4d7f-84cf-4759a12b625d'
(
    `event_date` Date,
    `event_time` DateTime,
    ...
    `ProfileEvent_QueryResultCacheHits` UInt64,
    `ProfileEvent_QueryResultCacheMisses` UInt64,
    ...
    `ProfileEvent_S3GetObjectMetadata` UInt64,
    ...
    `ProfileEvent_DiskS3GetObjectMetadata` UInt64,
